...
class ULP {
  ...
  public:
    //gas sensor settings
    float pSf = 4.24;              //initializers for sensor
    float pVcc = 4.96;  //analog read reference voltage, usually 5 V for Uno
    float pVsup = 3.284; //voltage supplied to ULP, !!!! max 3.3 V !!!!
    ...
    float pTc = 0.007;          //sensitivity coeficient
    float pn = 13.6;           //exponential correction to baseline
    ...
    float pGain = 100;     //gain of trans impedance amplifier (TIA)
